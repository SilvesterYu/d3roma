...
if __name__ == "__main__":
    ...
    overrides = [
        ...
        "task.image_size=[480,640]", # -- here change it according to the collected image
    ...
    left = np.array(Image.open("/home/lifanyu/Documents/GitHub/StereoCameras/RealSense/images/left_ir.png"))
    right = np.array(Image.open("/home/lifanyu/Documents/GitHub/StereoCameras/RealSense/images/right_ir.png"))
    raw = np.array(Image.open("/home/lifanyu/Documents/GitHub/StereoCameras/RealSense/images/depth_image.png")) * 1e-3
    rgb = np.array(Image.open("/home/lifanyu/Documents/GitHub/StereoCameras/RealSense/images/color_image.png"))
